...
Route ::group(['prefix' => 'product-group', 'as' => 'product-group.'], function () {
...
Route ::group(['prefix' => 'tag', 'as' => 'tag.', 'middleware' => 'auth:api'], function () {
    ...
    Route ::get('/find/{id}', [TagController::class, 'find']) -> name('tag.find');
});

Route ::group(['prefix' => 'attribute', 'as' => 'attribute.', 'middleware' => 'auth:api'], function () {
    ...
    Route ::get('/find/{id}', [AttributeController::class, 'find']) -> name('attribute.find');
});
